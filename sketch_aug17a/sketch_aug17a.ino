...
NeoPatterns Ring1(24, 0, NEO_GRB + NEO_KHZ800, &Ring1Complete);
...
//    Stick.begin();
    ...
    // Kick off a pattern
    Ring1.TheaterChase(Ring1.Color(25,25,25), Ring1.Color(0,0,15), random(100));
...
//        Stick.Update();
    ...
    else // Back to normal operation
    {
        ...
        Ring1.Interval = 100;
        Ring1.Color1 = Ring1.Color(25,25,25);
...
void Ring1Complete()
{
//    if (digitalRead(3) == LOW)  // Button #2 pressed
//    {
//        // Alternate color-wipe patterns with Ring2
////        Ring2.Interval = 40;
//        Ring1.Color1 = Ring1.Wheel(255);
